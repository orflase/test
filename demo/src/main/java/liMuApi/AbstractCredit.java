...
import untils.HttpClient;
import untils.JsonUtils;
import untils.MDUtil;
...
public class AbstractCredit {
    ...
    public static final String apiKey = "8370602174417401";//API授权 key ---需客户指定
    public static final String apiSecret = "X6hxPNhp24KO5Kel6t6xtbYDUpXbnG3R";//API授权 secret---需客户指定
